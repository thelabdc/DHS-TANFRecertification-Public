...
# /DHS-TANFRecertification/, the top-level directory of the repository.
...
ggplot(df_baseline_outcomes, aes(recert_vs_appt_days, y = (100 * (..count..)/c(1172, 1176, 1172)))) + 
